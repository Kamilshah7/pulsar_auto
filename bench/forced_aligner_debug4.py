...
class ForcedAligner:
    ...
    def snap_boundaries_hybrid(self, words, pipes_or_audio_path, audio_path=None, vad_spans=None, preloaded_audio=None):
        ...
        _trail_mult   = float(os.environ.get("PULSAR_TRAIL_MULT", "0.04"))
        ...
        for i in range(len(refined) - 1):
            ...
            if is_true_pause:
                ...
                if w1["text"]=="was" and w2["text"]=="s-":
                    print("DBG_VARS", "c1=",c1,"c2=",c2,"starts_sib_w2=",starts_with_sibilant(w2["text"]),"ends_sib_w1=",ends_in_sibilant(w1["text"]),"ends_fric_w1=",ends_in_fricative(w1["text"]),"valley_rms=",valley_rms,"trail_thresh=",trail_thresh,"valley_t=",valley_t,"search_st=",search_st,"search_en=",search_en)
