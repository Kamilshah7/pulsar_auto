...
class ForcedAligner:
    ...
    def snap_boundaries_hybrid(self, words, pipes_or_audio_path, audio_path=None, vad_spans=None, preloaded_audio=None):
        ...
        for i in range(len(refined) - 1):
            ...
            if w1["text"]=="perfect" and w2["text"]=="yeah":
                print("DEBUG_PAIR", "pause_dur_raw=",pause_dur,"pipe_suggests_continuity=",pipe_suggests_continuity,"p_end=",p_end,"w1end=",w1["end"],"w2start=",w2["start"])
            ...
            if is_true_pause:
                ...
                if pipe_suggests_continuity and ends_in_stop(w1["text"]):
                    print("DEBUG_CLAMP", w1["text"], w2["text"], "pause_dur=",pause_dur,"p_end=",p_end,"w2start=",w2["start"],"w1_end_t_before=",w1_end_t)
