...
def exp_h_forced_alignment():
    pass # It's now the default generate_acoustic_baseline in pipeline.py

if __name__ == "__main__":
    orch = ExperimentOrchestrator()
    orch.run_experiment("Wav2Vec2 Forced Alignment (New Architecture)", exp_h_forced_alignment)
    orch.print_results()
